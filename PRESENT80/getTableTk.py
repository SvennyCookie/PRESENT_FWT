...
for item in mask_list:    
    ...
    k1_16_cross_str = get_red_str(k1_cross,k1_green)
    k2_16_cross_str = get_red_str(k2_cross,k2_green)
    k28_16_cross_str = get_red_str(k28_cross,k28_green)
    k29_16_cross_str = get_red_str(k29_cross,k29_green)            
    
    #print(k1_cross_str)
    T_str.append("$k_1$: "+str(k1_16_cross_str)+"\n$k_2$: "+str(k2_16_cross_str)+"\n$k_{28}$: "+str(k28_16_cross_str)+"\n$k_{29}$: "+str(k29_16_cross_str))
